...
class Create(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        cls._build_args_task_properties_create(install_patches_post_tasks.Element)

        install_patches_pre_tasks = cls._args_schema.install_patches_pre_tasks
        install_patches_pre_tasks.Element = AAZObjectArg()
        cls._build_args_task_properties_create(install_patches_pre_tasks.Element)
    ...
    class MaintenanceConfigurationsCreateOrUpdate(AAZHttpOperation):
        ...
        def content(self):
            ...
            if post_tasks is not None:
                _build_schema_task_properties_create(post_tasks.set_elements(AAZObjectType, "."))

            pre_tasks = _builder.get(".properties.installPatches.tasks.preTasks")
            if pre_tasks is not None:
                _build_schema_task_properties_create(pre_tasks.set_elements(AAZObjectType, "."))
...
def _build_schema_task_properties_create(_builder):
    if _builder is None:
        return
